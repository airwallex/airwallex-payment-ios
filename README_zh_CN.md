...
请确保您已经添加对 `Airwallex` 或 `AirwallexPaymentSheet` 的依赖。 在结账时使用 [AWXUIContext](https://airwallex.github.io/airwallex-payment-ios/6.5.0/documentation/airwallex/awxuicontext/) 启动支付流程，用户能够通过支付列表选择您支持的支付方式。
``` swift
...
[PaymentSessionHandler](https://airwallex.github.io/airwallex-payment-ios/6.5.0/documentation/airwallex/paymentsessionhandler/)是 API 集成的核心。
