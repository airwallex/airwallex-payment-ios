...
[PaymentSessionHandler](https://airwallex.github.io/airwallex-payment-ios/6.3.2/documentation/airwallex/paymentsessionhandler) is at the center of the API integration.
```swift
