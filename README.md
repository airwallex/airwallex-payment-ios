...
Upon checkout, use [AWXUIContext](https://airwallex.github.io/airwallex-payment-ios/6.1.9/documentation/airwallex/awxuicontext) to present the payment flow where the user will be able to select the payment method.
...
[PaymentSessionHandler](https://airwallex.github.io/airwallex-payment-ios/6.1.9/documentation/airwallex/paymentsessionhandler) is at the center of the API integration.
```swift
