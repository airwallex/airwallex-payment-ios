...
- (instancetype)init {
    if (self = [super init]) {
        ...
        self.lang = [NSBundle preferredLocalizationsFromArray:NSBundle.resourceBundle.localizations forPreferences:NSBundle.mainBundle.localizations].firstObject ?: @"en";
    }
