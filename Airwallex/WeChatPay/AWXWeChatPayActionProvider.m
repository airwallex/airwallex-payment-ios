    ...
    [WXApi sendReq:request
        completion:^(BOOL success) {
            if (!success) {
                ...
                [self.delegate provider:self didCompleteWithStatus:AirwallexPaymentStatusFailure error:[NSError errorForAirwallexSDKWith:NSLocalizedString(@"Failed to request WeChat service.", nil)]];
