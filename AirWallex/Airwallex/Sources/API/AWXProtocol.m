...
static AWXExtendedProtocol *allExtendedProtocols = NULL;
...
void _protocol_extension_merge(AWXExtendedProtocol *extendedProtocol, Class containerClass)
{
    // Instance methods
...
void _protocol_extension_load(Protocol *protocol, Class containerClass)
{
    ...
    if (resultIndex == SIZE_T_MAX) {
        allExtendedProtocols[extendedProtcolCount] = (AWXExtendedProtocol){
            .protocol = protocol,
...
static void _protocol_extension_inject_class(Class targetClass, AWXExtendedProtocol extendedProtocol)
{
...
__attribute__((constructor)) static void _protocol_extension_inject_entry(void)
{
    ...
    @autoreleasepool {
        for (unsigned protocolIndex = 0; protocolIndex < extendedProtcolCount; ++protocolIndex) {
            AWXExtendedProtocol extendedProtcol = allExtendedProtocols[protocolIndex];
