...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  install_xcframework "${PODS_ROOT}/AirwallexBehavioralBiometrics/RLTMXBehavioralBiometrics.xcframework" "" "true" "ios-i386_x86_64-simulator/RLTMXBehavioralBiometrics.framework" "ios-arm64_armv7_armv7s/RLTMXBehavioralBiometrics.framework"
  install_xcframework "${PODS_ROOT}/AirwallexProfiling/RLTMXProfiling.xcframework" "" "true" "ios-arm64_armv7_armv7s/RLTMXProfiling.framework" "ios-i386_x86_64-simulator/RLTMXProfiling.framework"
  install_xcframework "${PODS_ROOT}/AirwallexProfilingConnections/RLTMXProfilingConnections.xcframework" "" "true" "ios-i386_x86_64-simulator/RLTMXProfilingConnections.framework" "ios-arm64_armv7_armv7s/RLTMXProfilingConnections.framework"
fi
