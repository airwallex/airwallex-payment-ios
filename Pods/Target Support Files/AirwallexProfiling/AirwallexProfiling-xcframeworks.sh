...
install_xcframework "${PODS_ROOT}/AirwallexProfiling/RLTMXProfiling.xcframework" "AirwallexProfiling" "framework" "ios-arm64_armv7_armv7s" "ios-i386_x86_64-simulator"
