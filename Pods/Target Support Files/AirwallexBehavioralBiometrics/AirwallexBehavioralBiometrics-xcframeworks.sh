...
install_xcframework "${PODS_ROOT}/AirwallexBehavioralBiometrics/RLTMXBehavioralBiometrics.xcframework" "AirwallexBehavioralBiometrics" "framework" "ios-i386_x86_64-simulator" "ios-arm64_armv7_armv7s"
